...
class TurfMiscTest {
    ...
    fun testLineIntersect() {
        ...
        assertEquals(LngLat(-120.93653884065287, 51.287945374086675), intersect[0])
    }
    ...
    fun testLineSlice() {
        ...
        val result = lineSlice(start.geometry as Position, stop.geometry as Position, lineString.geometry as LineString)
    ...
    fun testNearestPointOnLine() {
        ...
        val result = nearestPointOnLine(multiLine.geometry as MultiLineString, point.geometry as Point)
